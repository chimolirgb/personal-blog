...
def home():
    ...
    if form.validate_on_submit():
        ...
        msg.html = '<h2>Welcome to YourQuoteBlog.</h2> <p>The personal blog is an ongoing online diary or commentary written by an individual, rather than a corporation or organization</p>'
        mail.send(msg)
        flash('You have been added to my subscription', 'success')
